...
if __name__ == '__main__':
    ...
    parser.add_argument('--add_challenge', action="store_true", default=config['add_challenge'], help='Add challenge setting')
    parser.add_argument('--average_setting', type=str, default=config['average_setting'], help='Average setting')
    parser.add_argument('--IID', action="store_true", default=config['IID'], help='IID setting')
    parser.add_argument('--detection_divergence', type=str, default=config['detection_divergence'], help='Detection divergence')
    parser.add_argument('--detection_halflife', type=int, default=config['detection_halflife'], help='Detection half-life')
    parser.add_argument('--detection_method', type=str, default=config['detection_method'], help='Detection method')
